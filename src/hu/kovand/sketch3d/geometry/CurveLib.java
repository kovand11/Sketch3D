...
public class CurveLib {
	...
	/**Approxmates a given set of points with bspline
	 * 
	 * @param px controll point x-s
	 * @param py controll point y-s
	 * @param pz controll point z-s
	 * @param p bspline p param
	 * @param n bspline n param
